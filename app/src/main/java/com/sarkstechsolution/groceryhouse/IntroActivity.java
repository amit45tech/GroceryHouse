...
import com.sarkstechsolution.groceryhouse.Adapter.IntroViewPagerAdapter;
...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (restorePrefData()) {
            ...
            Intent mainActivity = new Intent(getApplicationContext(),FetchLocationActivity.class );
